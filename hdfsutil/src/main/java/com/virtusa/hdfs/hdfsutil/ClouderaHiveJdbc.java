...
public class ClouderaHiveJdbc {
	
	// here is an example query based on one of the Hue Beeswax sample tables 
	private static final String SQL_STATEMENT = "select * from order_items limit 50";
	
	// set the impalad host
	private static final String HIVE_HOST = "192.168.1.227";
